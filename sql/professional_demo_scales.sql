-- PHQ-9 / GAD-7 答辩演示用量表（与代码中 questionnaire.type = PHQ9_DEMO、GAD7_DEMO 对应）
-- 说明：非临床认证工具，划界逻辑见 QuizServiceImpl.buildConclusion；论文与界面请标注「答辩演示」。
-- 注意：本文件与 consult_test_data.sql 内容等价（二选一执行），请勿重复导入。
